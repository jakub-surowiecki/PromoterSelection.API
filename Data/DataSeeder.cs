...
public static class DataSeeder
{
    public static void Seed(AppDbContext context)
    {
        ...
        var supervisors = new[]
        {
            new User { Email = "prof.nowak@university.edu", PasswordHash = BCrypt.Net.BCrypt.HashPassword("pass123"), Role = UserRole.Supervisor, FirstName = "Andrzej", LastName = "Nowak", Title = "Prof. dr hab.", MaxStudents = 1 },
        ...
        var students = new[]
        {
            new User { Email = "student1@student.edu", PasswordHash = BCrypt.Net.BCrypt.HashPassword("pass123"), Role = UserRole.Student, FirstName = "Piotr", LastName = "Zając", AlbumNumber = "123456", GPA = 4.5, IsGPAConfirmed = true },
            ...
            new User { Email = "student3@student.edu", PasswordHash = BCrypt.Net.BCrypt.HashPassword("pass123"), Role = UserRole.Student, FirstName = "Marek", LastName = "Wróbel", AlbumNumber = "123458", GPA = 4.0, IsGPAConfirmed = true },
            new User { Email = "student4@student.edu", PasswordHash = BCrypt.Net.BCrypt.HashPassword("pass123"), Role = UserRole.Student, FirstName = "Agnieszka", LastName = "Dąbrowska", AlbumNumber = "123459", GPA = 4.0, IsGPAConfirmed = true },
